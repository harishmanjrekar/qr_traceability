		...
		<div class="w3-main" style="margin-left:300px;margin-top:43px;">
		  ...
		  <!-- Header -->
			...
			include ('database_my.php');
				...
				$count=1;
				$sel_query="SELECT * FROM `mastertable` WHERE status = 1";

				$result2 = mysqli_query($connection,$sel_query);
				while($row2 = mysqli_fetch_assoc($result2)) { ?>
			<tr>
			<td align="center"><?php echo $row2['Transaction_id']; ?></td>
			<td align="center"><?php echo $row2['farmer_id'];; ?></td>
			<td align="center"><?php echo $row2['farmer_name'];; ?></td>
			<td align="center"><?php echo $row2['farm_detail'];; ?></td>
			<td align="center"><?php echo $row2['quantity'];; ?></td>
			<td align="center"><?php echo $row2['status'];; ?></td>
			<td align="center"><a href="add-pre-proc.php?id=<?php echo $row2['Transaction_id'];?>">Add</a></td>
			</tbody>
				<?php } ?>
			</table>
		</div>
