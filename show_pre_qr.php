...
<html>
	<head>
		<title>Traceability | Show Pre Processing Procurement Details</title>
		<meta charset="UTF-8">
	...
	<body class="w3-white">
		...
		<br>
		<h3 class="w3-text"><font color="blue"><center>See Pre processing QR Details</center></font></h3>
		...
		<div class="form">
			...
			<form name="add-proc" action="fetch_pre_QR.php" method="post" enctype="multipart/form-data">
			<center>
