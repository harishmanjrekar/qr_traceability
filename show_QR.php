...
<html>
	...
	<body class="w3-white">
		...
		<br>
		<h3 class="w3-text"><font color="blue"><center>See Procurement QR Details</center></font></h3>
		...
		<div class="form">
			...
			<form name="add-proc" action="fetch_QR.php" method="post" enctype="multipart/form-data">
			<center>
