	...
	<body class="w3-light-grey">
		...
		<div class="w3-main" style="margin-left:300px;margin-top:43px;">
		  ...
		  <!-- Header -->
			...
			<th><strong><font color="">Status</font></strong></th>
			<th><strong><font color="">See More Details</font></strong></th>
			</thead>
			<tbody>
			<?php
			include ('database_my.php');
				...
				$count=1;
				$sel_query="SELECT * FROM `mastertable` where status=3";
			...
			<td align="center"><a href="tryon.php?id=<?php echo $row2['Transaction_id']; ?>&rid=<?php echo $row2['status']; ?>">See</a></td>
			</tbody>
				<?php } ?>
			</table>
		</div>
