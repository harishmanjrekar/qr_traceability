...
<html>
	<head>
		<title>Traceability | Production Details</title>
		<meta charset="UTF-8">
	...
	<body class="w3-light-grey">
		...
		<div class="w3-main" style="margin-left:300px;margin-top:43px;">
		  ...
		  <!-- Header -->
			...
			<th><strong><font color="">Reel ID</font></strong></th>
			...
			include ('database_my.php');
				...
				$count=1;
				$sel_query="SELECT * FROM `reels` where Reel_status=1;";
				$result2 = mysqli_query($connection,$sel_query);
				while($row2 = mysqli_fetch_assoc($result2)) { ?>
			<tr>
			<td align="center"><?php echo $row2['Transaction_id']; ?></td>
			<td align="center"><?php echo $row2['Reel_id']; ?></td>
			<td align="center"><a href="add-prod.php?id=<?php echo $row2['Transaction_id']; ?>&rid=<?php echo $row2['Reel_id']; ?>">Add</a></td>
			</tbody>
				<?php } ?>
			</table>
		</div>
